...
export default function LiquidEther({
  ...
  useEffect(() => {
    ...
    // Dark background color (visible but dark)
    const bgVec4 = new THREE.Vector4(0.08, 0.08, 0.12, 1);
    ...
    class Simulation {
      ...
      createAllFBO() {
        ...
        for (const key in this.fbos) {
          (this.fbos as Record<string, THREE.WebGLRenderTarget>)[key] = new THREE.WebGLRenderTarget(this.fboSize.x, this.fboSize.y, opts);
        }
      }
      createShaderPass() {
      ...
      resize() {
        this.calcSize();
        for (const key in this.fbos) {
          (this.fbos as Record<string, THREE.WebGLRenderTarget>)[key].setSize(this.fboSize.x, this.fboSize.y);
        }
      }
      update() {
